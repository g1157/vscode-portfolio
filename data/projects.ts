...
export const projects: Project[] = [
  ...
  {
    title: 'CPA Usage Stats',
    description: 'CLIProxyAPI 用量统计与请求日志',
    logo: '/logos/json_icon.svg',
    link: 'https://stats.117911.xyz',
    slug: 'cpa-usage-stats',
    category: 'infrastructure',
  },
  {
    title: 'Unified Status',
    description: '服务器、CPA 与 Kuma 聚合状态面板',
    logo: '/logos/vscode_icon.svg',
    link: 'https://status.117911.xyz',
    slug: 'unified-status',
    category: 'infrastructure',
  },
  {
    title: 'Uptime Kuma',
    description: '服务可用性监控与状态页',
    logo: '/logos/html_icon.svg',
    link: 'https://kuma.117911.xyz',
    slug: 'uptime-kuma',
    category: 'infrastructure',
  },
  {
